...
if (isset($_POST['submit']) && isset($_POST['event_name']) && isset($_POST['event_location'])  && isset($_POST['description'])  ) {
    ...
    $eventDescripteion = $_POST['description'];
        ...
        $query = " INSERT INTO `tranings` (`traning_name`, `traning_location`, `traning_description`) VALUES ('$eventName', '$eventLocation', '$eventDescripteion'); ";
 ...
 <body>
    ...
    <div class="nav1">
     ...
     <button> <a href='wellcomeAdmin.php' style="text-decoration:none"> Home </a> </button>
                                           <center> <h1> ADD Traning </h1> </center>

    <form action="addTraning.php" method="POST">

    <center>
    <input type="text" name="event_name" placeholder="Traning Name"> <br><br><br>
    <input type="text" name="event_location" placeholder="Traning location" > <br><br><br>
    <input type="text" name="description" placeholder="Traning description"> <br><br><br>
