...
<html>
 ...
 <body>
    ...
    <div class="nav1">
     ...
     <button> <a href='addTraning.php' style="text-decoration:none"> ADD Traning </a> </button>
...
<button> <a href="deleteTraning.php?code=<?php echo $id; ?>" style="text-decoration:none">  Delete  </a> </button>
<button> <a href="updateTraning.php?code=<?php echo $id; ?>" style="text-decoration:none">  Update  </a> </button>
