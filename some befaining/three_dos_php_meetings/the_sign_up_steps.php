...
// convert input from the form to variables in php-------
...
//----------------------------------------------------------------
//$query is some of query lsnguage(sql) to database
//the second if statment to see if the connect sucsess or not
//to our dataase...and this for sign up
$query = "insert into db_tifa(user_name,password,email,phone)
   values('$name','$pass','$email','$phone');";
//---------------------------------------------------
// the if statment to check if the data inserted or not
// the mysqli_query() function to insert data
...
//-7mysqli_query() function to insert to our database the ($ds,$query)
